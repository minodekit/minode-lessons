...
|               | Chainable RGB LED                  |        1 | I2C            |       | A colorful LED. The color and brightness can be programable                                  |
...
|               | Mini Fan                           |        1 | Digital Output |       | A DC motor + orbit fan                                                                       |
|               | Speaker                            |        1 | Digital Output |       | Voice output speaker                                                                         |
| Cables        | Universal 4 Pin Buckled 30cm Cable |       10 | NA             |       |                                                                                              |
|               | Micro-B USB cable                  |        0 | NA             |       | Power input                                                                                  |
...
> TODO: Insert a image about connect board(Ê¾ÒâÍ¼)
...
We'll focus more on the Microsoft Touch Develop. We'll also provide Microsoft Block Editor code.
...
> Note: The library is based on Microsoft Touch Develop editor.
...
|    3 | Reference Guide     | 1 module 1 guide. Such as Spec, Example Code, Library Reference and etc. |
